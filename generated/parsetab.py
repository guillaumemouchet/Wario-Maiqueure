...
_lr_productions = [
  ...
  ('expression -> ( expression )','expression',3,'p_expression_paren','parser.py',56),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parser.py',60),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parser.py',61),
]
